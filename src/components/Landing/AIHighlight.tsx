...
const AIHighlight = () => {
  return (
    <section id="ai" className="py-24 bg-slate-950 overflow-hidden relative w-full flex flex-col items-center">
      {/* Decorative Blur */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="order-2 lg:order-1">
            <div className="relative group">
              ...
              <div className="relative bg-white/5 backdrop-blur-md border border-white/10 rounded-[3rem] p-10 md:p-14 shadow-2xl overflow-hidden">
                <div className="flex items-center gap-4 mb-12">
                  ...
                  <div>
                    <h4 className="text-white font-bold text-lg tracking-tight">Lidus Assistant</h4>
                ...
                <div className="space-y-5">
                  <div className="bg-slate-900/50 p-6 rounded-2xl border border-white/5">
                    <p className="text-xs text-slate-400 font-medium italic">"Analizando cumplimiento normativo..."</p>
                  </div>
                ...
                <div className="mt-14 grid grid-cols-2 gap-8">
                  <div>
                    <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest block mb-2">Automatización</span>
                    <span className="text-3xl font-black text-white tracking-tighter">100%</span>
                  </div>
                  <div>
                    <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest block mb-2">Integración</span>
                    <span className="text-3xl font-black text-white tracking-tighter">Real</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-white tracking-tight mb-8 leading-tight">
              Decisiones inteligentes <br /> en tiempo real.
            </h3>
            ...
            <ul className="space-y-6">
              {[
                ...
                <li key={i} className="flex items-center gap-4 group">
                  <div className="w-6 h-6 rounded-full bg-blue-600/10 flex items-center justify-center text-blue-500 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
                    <CheckCircle2 size={16} />
                  </div>
                  <span className="text-slate-300 font-semibold tracking-tight">{text}</span>
                </li>
              ))}
            </ul>
          </div>
