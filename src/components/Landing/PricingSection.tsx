...
const PricingSection = () => {
  return (
    <section id="pricing" className="py-24 bg-white w-full flex flex-col items-center">
          ...
          {plans.map((plan, index) => (
            <div 
              ...
              className={`relative p-10 rounded-[2.5rem] border transition-all duration-500 flex flex-col ${
                plan.popular 
                  ? 'border-slate-800 shadow-2xl shadow-slate-200/50 scale-105 z-10 bg-slate-950 text-white' 
            ...
            >
              ...
              <Link 
                ...
                className={`group w-full py-4.5 rounded-2xl font-bold text-sm transition-all flex items-center justify-center gap-2 ${
                  plan.popular
