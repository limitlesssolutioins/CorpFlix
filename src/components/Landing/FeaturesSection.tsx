...
const FeaturesSection = () => {
  return (
    <section id="features" className="py-24 bg-white w-full flex flex-col items-center">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-10 lg:px-16">
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          <p className="text-4xl font-black text-slate-900 tracking-tight mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="group bg-slate-50/50 p-10 rounded-[2.5rem] border border-slate-100 hover:bg-white hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500"
            >
              <div className="w-14 h-14 rounded-2xl bg-white shadow-sm border border-slate-100 flex items-center justify-center mb-8 text-blue-600 group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-600 group-hover:rotate-6 transition-all duration-500">
